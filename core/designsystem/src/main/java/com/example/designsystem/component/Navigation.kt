 ...
 */
@Composable
fun RowScope.PDNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
 ...
 * @param navigationSuiteItems A slot to display multiple items via [PDNavigationSuiteScope].
 * @param windowAdaptiveInfo The window adaptive info.
 * @param content The app content inside the scaffold.
 */
@Composable
fun PDNavigationSuiteScaffold(
    navigationSuiteItems: PDNavigationSuiteScope.() -> Unit,
    modifier: Modifier = Modifier,
 ...
 */
class PDNavigationSuiteScope internal constructor(
